...
impl Pipeline {
    ...
    fn process_chunk(&self, chunk: &[HashMap<String, String>], offset: u64) -> Result<()> {
    ...
    fn write_storage_chunk(&self, chunk: &[HashMap<String, String>]) -> Result<()> {
    ...
    fn finalize(&self) -> Result<()> {
        ...
        // 0. Écriture de la Primary Key FST
        ...
        for idx_config in &self.config.indexes {
            ...
            if idx_config.r#type == IndexType::Text {
                ...
                let col_name = if idx_config.r#type == IndexType::GeoPoint {
                ...
                if let Some(values) = bitmaps.get(&col_name) {
                    ...
                    if idx_config.r#type == IndexType::GeoPoint {
